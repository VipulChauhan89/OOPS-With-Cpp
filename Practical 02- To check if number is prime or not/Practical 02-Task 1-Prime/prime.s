	...
	.p2align	2                               ## -- Begin function _Z10SquareRootf
LCPI0_0:
...
LCPI0_2:
	...
	.section	__TEXT,__text,regular,pure_instructions
	.globl	__Z10SquareRootf
	.p2align	4, 0x90
__Z10SquareRootf:                       ## @_Z10SquareRootf
	.cfi_startproc
## %bb.0:
	pushq	%rbp
...
L_.str:                                 ## @.str
	.asciz	"Enter the number to check if the number is prime or not\n"
