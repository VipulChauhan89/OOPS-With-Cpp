...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__ZN6Member4nameEv              ## -- Begin function _ZN6Member4nameEv
	.weak_definition	__ZN6Member4nameEv
	.p2align	4, 0x90
__ZN6Member4nameEv:                     ## @_ZN6Member4nameEv
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	movq	%rdi, %rcx
	movq	__ZNSt3__14coutE@GOTPCREL(%rip), %rdi
	movq	__ZZN6Member4nameEvE1a@GOTPCREL(%rip), %rax
	movq	%rcx, -8(%rbp)
	movl	(%rax), %ecx
	addl	$1, %ecx
	movl	%ecx, (%rax)
...
L_.str.2:                               ## @.str.2
	...
	.globl	__ZZN6Member4nameEvE1a          ## @_ZZN6Member4nameEvE1a
	.weak_definition	__ZZN6Member4nameEvE1a
	.p2align	2
__ZZN6Member4nameEvE1a:
	.long	0                               ## 0x0

	.section	__TEXT,__cstring,cstring_literals
L_.str.3:                               ## @.str.3
	.asciz	"count for object is : "
